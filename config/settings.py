...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-m3h&y$uh&%ud@6lr=p24wd%$e(hhl-x)xofe)r_szhl4v+6s@d",
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("DJANGO_DEBUG", "True").lower() in {"1", "true", "yes", "on"}
USE_WHITENOISE = os.getenv("DJANGO_USE_WHITENOISE", "False").lower() in {
    "1",
    "true",
    "yes",
    "on",
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "wanportal"),
        "USER": os.getenv("DB_USER", "wanuser"),
